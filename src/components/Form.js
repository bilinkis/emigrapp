      ...
      {!formSent ? (
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="block text-gray-700 mb-2">
                Tienes algún familiar directo (padres, abuelos, bisabuelos) que
                hayan nacido en España o tengan nacionalidad Española?
              </label>
              <div className="flex items-center mb-2">
                <input
                  type="radio"
            ...
            {formData.family === "true" && (
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">
                  Documentación con la que ya cuentas
                </label>
                <div className="flex items-center mb-2">
                  <input
                    type="checkbox"
                    ...
                    checked={formData.documentation.includes(
                      "Pasaporte Europeo"
                    )}
                    onChange={handleChange}
                    className="mr-2"
        ...
        <>
          ...
          {formData.family === "true" && !paid ? (
            <>
              <h2 className="text-2xl font-bold mb-6 text-center mt-12">
                Tu caso aplica para usar los servicios de Emigrapp!
              </h2>
              <Pricing
            ...
            <>
              <h2 className="text-2xl font-bold mb-6 text-center mt-12">
                Por el momento no podemos ayudarte, pero te enviaremos novedades
                a tu email cuando puedas usar Emigrapp. Gracias!
              </h2>
            </>
          ) : null}
        </>
