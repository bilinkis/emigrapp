                ...
                <nav className={`w-full md:w-auto md:flex ${isOpen ? 'block' : 'hidden'} mt-4 md:mt-0`}>
                    <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        {router.pathname === '/' && (
                            <>
                                <li className="relative group">
                                    <ScrollLink to="pricing" smooth={true} offset={-72} className="cursor-pointer">
                                ...
                                <li className="relative group">
                                    <ScrollLink to="description" smooth={true} offset={-72} className="cursor-pointer">
                                        <span className="transition-transform transform hover:scale-110 group-hover:shadow-lg group-hover:bg-white group-hover:text-blue-500 rounded-md px-2 py-1">Pricing</span>
                                    </ScrollLink>
                                </li>
                                <li className="relative group">
